...
_ACTION_KEYWORDS = re.compile(
    r"напиши|написать|отправь|отправить|пошли|скинь|перешли|переслать|пересла[лть]|"
    ...
    r"посмотри|посмотреть|проверь|проверить|проверит|узнай|узнать|"
    r"спроси|спросить|запусти|выполни|сделай|сделать|"
    r"прислал|приш[её]л\s+ли|ответил\s+ли|написал\s+ли|не\s+прислал",
    re.IGNORECASE,
)
